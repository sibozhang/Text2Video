...
public:
  ...
  CPUByteStorage(Context* context, THStorage *wrapped);
  CPUByteStorage(Context* context, size_t size);
  CPUByteStorage(Context* context, size_t size, Allocator* allocator);
  ...
  virtual CPUByteStorage& set(size_t ind, Scalar value) override;
  virtual CPUByteStorage& fast_set(size_t ind, Scalar value) override;
