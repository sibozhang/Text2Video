...
struct CUDAFloatType final : public Type {
  ...
  virtual Tensor & _th_sigmoid_out(Tensor & result, const Tensor & self) const override;
  virtual Tensor _th_sigmoid(const Tensor & self) const override;
  ...
  virtual Tensor & _erfc_out(Tensor & result, const Tensor & self) const override;
  virtual Tensor _erfc(const Tensor & self) const override;
  ...
  virtual Tensor _th_var(const Tensor & self, bool unbiased) const override;
  ...
  virtual Tensor _th_std(const Tensor & self, bool unbiased) const override;
  ...
  virtual Tensor & _getri_out(Tensor & output, const Tensor & self) const override;
  virtual Tensor _getri(const Tensor & self) const override;
  ...
  virtual Tensor & thnn_grid_sampler_bilinear2d_forward_out(Tensor & output, const Tensor & self, const Tensor & grid, int64_t padding_mode) const override;
  virtual Tensor thnn_grid_sampler_bilinear2d_forward(const Tensor & self, const Tensor & grid, int64_t padding_mode) const override;
  virtual std::tuple<Tensor &,Tensor &> thnn_grid_sampler_bilinear2d_backward_out(Tensor & grad_input, Tensor & grad_grid, const Tensor & grad_output, const Tensor & self, const Tensor & grid, int64_t padding_mode) const override;
  virtual std::tuple<Tensor,Tensor> thnn_grid_sampler_bilinear2d_backward(const Tensor & grad_output, const Tensor & self, const Tensor & grid, int64_t padding_mode) const override;
  virtual Tensor & thnn_grid_sampler_bilinear3d_forward_out(Tensor & output, const Tensor & self, const Tensor & grid, int64_t padding_mode) const override;
  virtual Tensor thnn_grid_sampler_bilinear3d_forward(const Tensor & self, const Tensor & grid, int64_t padding_mode) const override;
  virtual std::tuple<Tensor &,Tensor &> thnn_grid_sampler_bilinear3d_backward_out(Tensor & grad_input, Tensor & grad_grid, const Tensor & grad_output, const Tensor & self, const Tensor & grid, int64_t padding_mode) const override;
  virtual std::tuple<Tensor,Tensor> thnn_grid_sampler_bilinear3d_backward(const Tensor & grad_output, const Tensor & self, const Tensor & grid, int64_t padding_mode) const override;
