...
public:
  ...
  CPUHalfStorage(Context* context, THStorage *wrapped);
  CPUHalfStorage(Context* context, size_t size);
  CPUHalfStorage(Context* context, size_t size, Allocator* allocator);
  ...
  virtual CPUHalfStorage& set(size_t ind, Scalar value) override;
  virtual CPUHalfStorage& fast_set(size_t ind, Scalar value) override;
