...
inline std::tuple<Tensor,Tensor> Tensor::_th_min(int64_t dim, bool keepdim) const {
    return type()._th_min(*this, dim, keepdim);
}
...
inline std::tuple<Tensor,Tensor> Tensor::_th_max(int64_t dim, bool keepdim) const {
    return type()._th_max(*this, dim, keepdim);
}
inline std::tuple<Tensor,Tensor> Tensor::_th_kthvalue(int64_t k, int64_t dim, bool keepdim) const {
    return type()._th_kthvalue(*this, k, dim, keepdim);
}
inline std::tuple<Tensor,Tensor> Tensor::_th_mode(int64_t dim, bool keepdim) const {
    return type()._th_mode(*this, dim, keepdim);
}
inline Tensor Tensor::median() const {
    return type().median(*this);
}
inline std::tuple<Tensor,Tensor> Tensor::_th_median(int64_t dim, bool keepdim) const {
    return type()._th_median(*this, dim, keepdim);
}
...
inline Tensor Tensor::_th_all(int64_t dim, bool keepdim) const {
    return type()._th_all(*this, dim, keepdim);
}
inline Tensor Tensor::any() const {
    return type().any(*this);
}
inline Tensor Tensor::_th_any(int64_t dim, bool keepdim) const {
    return type()._th_any(*this, dim, keepdim);
}
inline Tensor Tensor::_abs() const {
    return type()._abs(*this);
}
inline Tensor Tensor::_th_sigmoid() const {
    return type()._th_sigmoid(*this);
}
...
inline Tensor Tensor::_erfc() const {
    return type()._erfc(*this);
}
...
inline Tensor Tensor::_th_var(int64_t dim, bool unbiased, bool keepdim) const {
    return type()._th_var(*this, dim, unbiased, keepdim);
}
inline Tensor Tensor::_th_var(bool unbiased) const {
    return type()._th_var(*this, unbiased);
}
inline Tensor Tensor::_th_std(int64_t dim, bool unbiased, bool keepdim) const {
    return type()._th_std(*this, dim, unbiased, keepdim);
}
inline Tensor Tensor::_th_std(bool unbiased) const {
    return type()._th_std(*this, unbiased);
}
inline Tensor Tensor::_th_norm(Scalar p, int64_t dim, bool keepdim) const {
    return type()._th_norm(*this, p, dim, keepdim);
}
...
inline Tensor Tensor::_getri() const {
    return type()._getri(*this);
}
...
inline Tensor & Tensor::_bernoulli_(double p, Generator * generator) {
    return type()._bernoulli_(*this, p, generator);
}
...
inline Tensor Tensor::_cast_Byte(bool non_blocking) const {
    return type()._cast_Byte(*this, non_blocking);
}
inline Tensor Tensor::_cast_Char(bool non_blocking) const {
    return type()._cast_Char(*this, non_blocking);
}
...
inline Tensor Tensor::_cast_Long(bool non_blocking) const {
    return type()._cast_Long(*this, non_blocking);
}
inline Tensor Tensor::_cast_Short(bool non_blocking) const {
    return type()._cast_Short(*this, non_blocking);
}
...
inline Tensor & Tensor::sparse_raw_resize_(IntList size, int64_t sparseDims, int64_t denseDims) {
    return type().sparse_raw_resize_(*this, size, sparseDims, denseDims);
}
inline Tensor Tensor::_sparse_mask(SparseTensorRef mask) const {
