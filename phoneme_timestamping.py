...
py_input=stripped_eng_punct
print('input', py_input)

words = stripped_eng_punct.split()
print('words', words)
...
for item in res['result']:
    ...
    tstamp=st + step
    # print(tstamp, item['word'])
    frame_idx = int(tstamp * fps + 0.5)

    if i > len_stripped-1:
        break

    n = text_file.write(str(frame_idx) + ' ' + words[i] + '\n')
    print(str(frame_idx), words[i], i)
    i=i+1
